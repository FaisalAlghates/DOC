    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            if ($docType === 'engineering') {
                $subDoc = \App\Models\EngineeringDocumentation::findOrFail($id);
                ...
                $subDoc = \App\Models\BestPracticeDocumentation::findOrFail($id);
                $docMain = $subDoc->documentation;
                ...
                // محاولة العثور على المستند الرئيسي مباشرة
                $docMain = \App\Models\Documentation::findOrFail($id);
                if ($docMain->doc_type === 'engineering') {
                    $subDoc = \App\Models\EngineeringDocumentation::where('documentation_id', $docMain->id)->first();
                } else {
                    $subDoc = \App\Models\BestPracticeDocumentation::where('documentation_id', $docMain->id)->first();
                }
            }
            
            \Log::info('Found main doc: ' . $docMain->id . ', type: ' . $docMain->doc_type);
            \Log::info('Found sub doc: ' . ($subDoc ? $subDoc->id : 'null'));
            ...
            \Log::info('Main document updated');
            ...
            if ($docMain->doc_type === 'engineering' && $subDoc) {
                ...
                \Log::info('Engineering sub-document updated');
                ...
                \Log::info('Best practice sub-document updated');
            }
            ...
            \Log::info('Document history created');
